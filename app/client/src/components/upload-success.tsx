      ...
      <div className="w-[25.125rem] pt-9 rounded-xl shadow-lg bg-zinc-50 flex flex-col items-center dark:bg-zinc-700">
        ...
        <div className="mt-[1.5625rem] max-w-[21.125rem] mb-[2.0625rem]">
          <div className="border border-custom-color-1 bg-custom-color-2 h-[2.125rem] rounded-lg w-full flex items-center p-2 pr-0 dark:bg-zinc-600 dark:border-zinc-700">
            <p className="truncate text-[.5rem] w-[80%] pr-2 text-custom-color">
              {uploadedPath}
            </p>
            <button
              className="bg-primary text-white p-3 w-[20%] h-[1.875rem] rounded-lg text-[.5rem] flex justify-center transition ease items-center hover:bg-primary-hover"
              onClick={setCopied}
              disabled={isCopied}
            >
